...
function selectedBox(id) {
    ...
    if (sign == "X") {
        ...
        selectedElement.style.textShadow = "2px 2px 4px red, -2px -2px 4px red"
        ...
        selectedElement.style.textShadow = "2px 2px 4px blue, -2px -2px 4px blue"
    }
